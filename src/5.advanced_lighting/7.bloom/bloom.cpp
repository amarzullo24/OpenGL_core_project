...
//        glUniformMatrix4fv(glGetUniformLocation(floor1_shader.Program, "view"), 1, GL_FALSE, glm::value_ptr(view));
//        glUniformMatrix4fv(glGetUniformLocation(floor1_shader.Program, "projection"), 1, GL_FALSE, glm::value_ptr(projection));
//        // Cubes
//        glBindVertexArray(cubeVAO);
...
//        glUniformMatrix4fv(glGetUniformLocation(floor1_shader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
...
//GLuint loadTexture(GLchar* path, GLuint )
//{
